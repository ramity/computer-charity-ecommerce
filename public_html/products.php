...
<html>
	<head>
		...
		<link rel="stylesheet" type="text/css" href="https://ramity.com/css/banner.css">
		<link rel="stylesheet" type="text/css" href="https://ramity.com/css/products.css">
	...
	<body>
		...
		<div id="products">
			<div id="productsinr">
				<a href="https://ramity.com/search?id=<?php echo $results['id'];?>&type=build">
					<div id="productspromo" style="background-image:url('https://ramity.com/img/builds/<?php echo $results['id'];?>.jpg')">
				...
				<div id="productspane">
					...
					{
						echo '<a href="https://ramity.com/search?id='.$value['id'].'&type=build">';
							echo '<div class="productspaneitem">';
								echo '<div class="productspaneitemtitle">'.$value['title'].' - $'.number_format($value['siteprice']/100,2,'.',',').'</div>';
								echo '<div class="productspaneitemimage" style="background-image:url(https://ramity.com/img/builds/'.$value['id'].'.jpg)"></div>';
							echo '</div>';
						echo '</a>';
					}
					?>
