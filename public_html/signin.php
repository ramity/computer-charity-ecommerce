...
require_once('../modules/log/check.php');
...
<html>
	...
	<body>
		...
		<div id="signin">
			<div id="signininr">
				<div id="signincontentpane" style="background-image:url('img/products/5.jpg')">
					...
					<div id="signincontentpanelower">
						...
						<img id="signincontentpanelowerright" src="img/rlogo2.png">
					</div>
				</div>
				<div id="signincontentpanetwo">
					<form action="signin" method="post" id="signincontentpanetwolog">
					...
					<form action="signin" method="post" id="signincontentpanetwosign">
		...
		<div id="signinimg" style="background-image:url('img/killzone4k.jpg');">
			<div id="signinimgpos">
